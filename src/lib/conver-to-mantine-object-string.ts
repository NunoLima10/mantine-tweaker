...
export function convertToMantineObjectString(style: Style): string {
  ...
  virtualColor,
   ...
   const theme =  createTheme({
        ...
        }", //light-mode body-color/background-color
        ...
        colors: {
          ...
          gray: [
            ...
            "${
              style.light["muted-foreground"] as string
            }", //placeholder-color, disabled-color
            "${
              lighten(style.light["muted-foreground"] as string, 0.15) as string
            }", //dimmed-color
          ...
          primarylight: [
            ...
            "${
              lighten(style.light.primary as string, 0.15) as string
            }", //color-filled-hover
            "#1c7ed6",
            "#1971c2",
            "#1864ab",
          ...
          primarydark: [
            ...
            "${
              lighten(style.dark.primary as string, 0.15) as string
            }", //color-filled-hover
            "#1c7ed6",
            "#1971c2",
            "#1864ab",
